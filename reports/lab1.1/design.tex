...
\begin{figure}[H]
\centering
\includegraphics[width=0.55\textwidth]{resources/Design/ModularImplementation/flowchart_led_driver.png}
\caption{Functional flowchart of the Led driver module}
\label{fig:flowchart_led_driver}
\end{figure}
...
\caption{Functional flowchart of the serialGetChar() input handler}
\label{fig:flowchart_stdio_serial}
\end{figure}
