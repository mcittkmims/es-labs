...
\begin{figure}[H]
\centering
\includegraphics[width=0.85\textwidth, height=4cm, keepaspectratio]{resources/Design/SystemArchitectureDiagrams/system_structural_diagram.png}
...
\begin{figure}[H]
\centering
\includegraphics[width=0.75\textwidth, height=4cm, keepaspectratio]{resources/Design/SystemArchitectureDiagrams/layered_architecture.png}
...
\begin{figure}[H]
\centering
\includegraphics[width=0.65\textwidth, height=4cm, keepaspectratio]{resources/Design/BlockDiagrams/flowchart_initialization.png}
...
\begin{figure}[H]
\centering
\includegraphics[width=0.65\textwidth, height=4cm, keepaspectratio]{resources/Design/BlockDiagrams/flowchart_main_loop.png}
...
\begin{figure}[H]
\centering
\includegraphics[width=0.65\textwidth, height=4cm, keepaspectratio]{resources/Design/ElectricalSchematics/electric_schema.png}
...
\begin{figure}[H]
\centering
\includegraphics[width=0.65\textwidth, height=4cm, keepaspectratio]{resources/Design/ElectricalSchematics/wokwi_circuit.png}
...
\begin{figure}[H]
\centering
\includegraphics[width=0.2\textwidth, height=4cm, keepaspectratio]{resources/Design/ModularImplementation/flowchart_led_init.png}
...
\begin{figure}[H]
\centering
\includegraphics[width=0.15\textwidth, height=4cm, keepaspectratio]{resources/Design/ModularImplementation/flowchart_led_turnon.png}
...
\begin{figure}[H]
\centering
\includegraphics[width=0.15\textwidth, height=4cm, keepaspectratio]{resources/Design/ModularImplementation/flowchart_led_turnoff.png}
...
\begin{figure}[H]
\centering
\includegraphics[width=0.2\textwidth, height=4cm, keepaspectratio]{resources/Design/ModularImplementation/flowchart_stdio_setup.png}
...
\begin{figure}[H]
\centering
\includegraphics[width=0.15\textwidth, height=4cm, keepaspectratio]{resources/Design/ModularImplementation/flowchart_stdio_putchar.png}
...
\begin{figure}[H]
\centering
\includegraphics[width=0.55\textwidth, height=4cm, keepaspectratio]{resources/Design/ModularImplementation/flowchart_stdio_serial.png}
...
\begin{figure}[H]
\centering
\includegraphics[width=0.50\textwidth, height=4cm, keepaspectratio]{resources/Design/ModularImplementation/flowchart_command_parser.png}
