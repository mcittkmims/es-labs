...
% PLACEHOLDER: If testing on physical hardware, document the following:
%
% \subsubsection{Hardware Assembly}
%
% Take a photo of the breadboard circuit with the Arduino Mega 2560,
% LED, and 220 Ohm resistor connected. Place the photo at:
% reports/lab1.1/resources/ObtainedResults/HardwareResults/hardware_setup.jpg
%
% \begin{figure}[H]
% \centering
% \includegraphics[width=0.55\textwidth]{resources/ObtainedResults/HardwareResults/hardware_setup.jpg}
% \caption{Physical hardware assembly --- Arduino Mega with LED circuit}
% \label{fig:hw_setup}
% \end{figure}

% \subsubsection{Firmware Upload}
%
% Take a screenshot of the PlatformIO upload process. Place at:
% reports/lab1.1/resources/ObtainedResults/HardwareResults/firmware_upload.png
%
% \begin{figure}[H]
% \centering
% \includegraphics[width=0.75\textwidth]{resources/ObtainedResults/HardwareResults/firmware_upload.png}
% \caption{Successful firmware upload to Arduino Mega 2560}
% \label{fig:firmware_upload}
% \end{figure}

% \subsubsection{Hardware Test Results}
%
% Take photos/screenshots of the physical LED in ON and OFF states
% with the serial monitor visible. Place at:
% reports/lab1.1/resources/ObtainedResults/HardwareResults/hw_led_on.jpg
% reports/lab1.1/resources/ObtainedResults/HardwareResults/hw_led_off.jpg
