...
The complete source code for Laboratory Work 1.1 is organized below by architectural layer. The full project is available in the GitHub repository.

% TODO: Add link to GitHub repository
% Repository: \url{https://github.com/mcittkmims/es-labs}
