...
% Placeholder: the user should add an image of the LCD module
% \begin{figure}[H]
% \centering
% \includegraphics[width=0.5\textwidth]{resources/DomainAnalysis/HardwareComponents/lcd1602_i2c.png}
% \caption{LCD 1602 display module with I2C backpack}
