...
\usepackage{graphicx}
% Global image size limits: images never exceed page width or 85% of page height.
% Individual \includegraphics[width=...] calls inherit the height ceiling automatically.
