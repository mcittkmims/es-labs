...
%                  minimum height=0.9cm, text centered, fill=blue!10},
%     node distance=1.5cm and 2cm]
%     \node[comp] (mcu)    {Arduino Mega 2560};
%     \node[comp] (lcd)    [above right=of mcu] {LCD 1602 (I2C)};
%     \node[comp] (keypad) [above left=of mcu]  {4x4 Keypad};
%     \node[comp] (led)    [below right=of mcu] {LEDs};
...
%     minimum height=0.7cm, text centered, draw=black, fill=gray!15]
% \tikzstyle{process}   = [rectangle, minimum width=2.5cm,
%     minimum height=0.7cm, text centered, draw=black, fill=blue!10]
% \tikzstyle{decision}  = [diamond, aspect=2.5, minimum width=2cm,
%     minimum height=0.7cm, text centered, draw=black, fill=orange!15]
...
%     \node (dec1)  [decision, below of=proc1, yshift=-0.3cm]{Condition?};
%     \node (proc2) [process,  below of=dec1,  yshift=-0.3cm]{Process 2};
...
% \caption{Wokwi simulation circuit}
